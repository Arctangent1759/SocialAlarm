...
class AlarmsControllerTest < ActionController::TestCase
  ...
  test "should create alarm" do
    assert_difference('Alarm.count') do
      post :create, alarm: { alarm_time: @alarm.alarm_time, expected: @alarm.expected, expected: @alarm.expected, sessions: @alarm.sessions }
    end
  ...
  test "should update alarm" do
    put :update, id: @alarm, alarm: { alarm_time: @alarm.alarm_time, expected: @alarm.expected, expected: @alarm.expected, sessions: @alarm.sessions }
    assert_redirected_to alarm_path(assigns(:alarm))
  end
